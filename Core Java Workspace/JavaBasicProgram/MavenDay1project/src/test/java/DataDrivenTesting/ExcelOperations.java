...
public class ExcelOperations {
  ...
  public void performOperationOnSheet() throws IOException {
	  /* Identify the path and name of excel file */
		FileInputStream fis = new FileInputStream(".\\AppData\\TestData.xlsx");
		...
		FileOutputStream fos = new FileOutputStream(".\\AppData\\TestData.xlsx");
...
//		cell.setCellValue("pass");
	...
	public void getFirstCellValueFromEachRow() throws IOException{
		...
		getCellValue(".\\AppData\\TestData.xlsx", "Sheet1", 0);
	}
